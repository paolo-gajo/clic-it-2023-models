...
# filter with 'misogynous' == 1 and 'racist' == 0 label
misogynous_filter = 1
racist_filter = 1
df_filtered = df[(df['misogynous'] == misogynous_filter) & (df['racist'] == racist_filter)]

class_id = 'm+r' if misogynous_filter == 1 and racist_filter == 1 else 'm' if misogynous_filter == 1 else 'r' if racist_filter == 1 else 'none'

print('df_filtered:', df_filtered.shape)
print('df_filtered:', df_filtered)
print(df_filtered['text'][:10], df_filtered['hs'][:10])
...
csv_file_path = f'/home/pgajo/working/incels/data/metrics/clic-it-2023-review/{model_name_simple}_{class_id}_{time_str}_metrics.csv'
